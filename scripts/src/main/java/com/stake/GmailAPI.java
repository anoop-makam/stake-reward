...
public class GmailAPI {
   ...
   * Application name.
   */
  private static final String APPLICATION_NAME = "outhClient";
  /**
  ...
  private static final String CREDENTIALS_FILE_PATH = File.separator + "credentials"
  ...
  private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
      throws IOException {
    // Load client secrets.
    InputStream in = GmailAPI.class.getResourceAsStream("/credentials/credentials.json");
    if (in == null) {
  ...
  public static void main(String... args) throws IOException, GeneralSecurityException {
    ...
    System.out.println("Total count of mails: " + getTotalCountOfMails());
